    ...
    <Modal
      ...
      <div slot="" class="pd-sm-20">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input v-model="data.manager_name" type="text" name="schoolname" class="form-control" placeholder="Enter school name">
                <!-- <div class="text-danger" id="studNameError" data-ajax-feedback="student name"></div> -->
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input v-model="data.status" type="text" name="website" class="form-control" placeholder="Enter wbsite">
                <!-- <div class="text-danger" id="studNameError" data-ajax-feedback="student name"></div> -->
              </div>
            </div>
          </div>
                ...
                <ul class="object administrator-checkbox-list">
                    <li v-for="product in products">
                        <label v-bind:for="product.id">
                            <input type="checkbox" v-bind:value="product.id" v-bind:id="product.id">
                            <span>{{ product.name }}</span>
                        </label>
                    </li>
                </ul>
                <!-- <input v-for="product in products" :key="product.id" v-bind:value="{ productid: product.id, productname: product.name }" type="checkbox">
...
<script>
  ...
  import { mapGetters } from 'vuex'
    ...
    async created(){
      ...
      const productsdb = await this.callApi('get', 'products');
      console.log('res',productsdb);
      if(res.status == 200){
        this.items = res.data
        this.products = productsdb.data
      }else{
        this.swr()
      }
    },
