              ...
              SchoolScan's latest CRM system provides a powerful yet User friendly tools to maintain customer relationships and the management of collected information about prospects.
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                  ...
                  <img :src="asset('/template/unipro/img/schoolscan.jpg')" alt="iChat" class="navbar-logo m-auto mb-3" width="50%">
                      ...
                      <input id="password" name="password" type="password" v-model="formData.password" class="form-control" placeholder="Enter New Password">
    ...
    export default {
      ...
      methods: {
        ...
        async submit(){
          ...
          const res = await this.callApi('post', 'resetpwd',this.formData)
          console.log('res',res)
          if(res.status == 200){
      ...
      async created(){
        this.formData.token = this.$route.query.id
