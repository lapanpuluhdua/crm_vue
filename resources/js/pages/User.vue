      ...
      <div class="">
        <div class="card">
          <div class="card-header">
            <b> LIST USER </b>
            <!-- <div v-if="$role(['Admin','Writer'])">You can edit posts.</div> -->
            <a v-if="$can(['User Create'])" href="#" @click="()=>{addModal=true;isAdding=true;clearForm()}" data-toggle="modal" class="btn btn-info btn-xs float-right">
                  ...
                  <tr  v-for="(user, i) in users" :key="i" v-if="users.length">
                    ...
                    <td>
                      <div class="dropdown custom-dropdown">
                        ...
                        <div v-if="$can(['User Update', 'User Delete'])" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <button v-if="$can(['User Update'])" @click="edit(user, i)" class="dropdown-item" data-toggle="modal"><i class="fa fa-edit"></i>&nbsp;&nbsp;Update</button>
                          <button v-if="$can(['User Delete'])" @click="showDeletingModal(user, i)" class="dropdown-item" data-toggle="modal"><i class="fa fa-trash"></i>&nbsp;&nbsp;Remove</button>
                        </div>
                      </div>
                    </td>
                  </tr>
  ...
  export default {
    ...
    methods: {
      ...
      async add(){
        ...
        if(this.data.password.trim()< 6) return this.e('Password must have a minimum of 6 Characters')
        // if(this.data.role_names.trim()=='') return this.e('Role is required')
